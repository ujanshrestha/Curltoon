...
export default function EducationAdd() {
    ...
    const handleSubmit = e => {
        ...
        axios.post('/api/freelancer/profile/education',
                                        ...
                                        <Card.Body>
                                            ...
                                            <div className="row">
                                                 ...
                                                 <div className="mb-3 col-md-12">
                                                    <label htmlFor="position" className="form-label text-muted"> Title </label>
                                                    <input 
                                                    type="text"
                                                    name="position"
                                                    value={expObj.title}
                                                ...
                                                <div className="mb-3 col-md-12">
                                                    <label htmlFor="position" className="form-label text-muted"> College </label>
                                                    <input 
                                                    type="text"
                                                    name="college"
                                                    value={expObj.college}
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-2">
                                                    ...
                                                    <input type="checkbox" value={expObj.stillStudying}
                                                    onChange={(e) => handleFormChange("stillStudying",e.target.checked)} />
