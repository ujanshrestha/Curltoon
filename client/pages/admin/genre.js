...
export default function Genre(){
    ...
    const {data,error,loaded,setLoaded} = useDataFetch("/api/admin/genre");
    ...
    const handleSubmit = e => {
        ...
        axios.post('/api/admin/genre',{id,title,description})
        .then(response =>
           { 
            if (response.status==200){
                handleModalClose();
                alert(id?"Genre Updated": "Genre Added");
                setId(null);
                setLoaded(false);
            }
           }
    ...
    return (
                            ...
                            <Card.Body>
                                <div className="row">
                                    ...
                                    <div className="col-md-4">
                                        <button onClick={handleModalShow} className="btn btn-primary">Create New Genre</button>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
        ...
        <Modal show={modalShow} onHide={handleModalClose}>
            ...
            <Modal.Title >
            {id ? <>Update Genre</> :  <>Create New Genre</>}        
            </Modal.Title>
            </Modal.Header>
            <Modal.Body>
