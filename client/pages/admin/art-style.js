...
export default function ArtStyle(){
    ...
    const {data,error,loaded,setLoaded} = useDataFetch("/api/admin/art-style");
    ...
    const handleSubmit = e => {
        ...
        axios.post('/api/admin/art-style',{id,title,description})
        .then(response =>
           { 
            if (response.status==200){
                handleModalClose();
                alert(id?"Art Style Updated": "Art Style Added");
                setId(null);
                setLoaded(false);
            }
           }
    ...
    return (
          ...
          <Head>
            ...
            <div className="row bg-contentbgColor">
                    ...
                    >
                            ...
                            <Card.Body>
                                <div className="row">
                                    <div className="col-md-8">
                                       <span className="h4"> Art Styles </span>
                                    </div>
                        ...
                        <Card>
                            <Card.Body>
                                <div className="text-center text-danger"> No Styles added
                                </div>
                            </Card.Body>
                        </Card>
                       </>}
        ...
        <Modal show={modalShow} onHide={handleModalClose}>
            ...
            <Modal.Title >
            {id ? <>Update Art Style</> :  <>Create New Art Style</>}        
            </Modal.Title>
            </Modal.Header>
            <Modal.Body>
