...
export default function AgeGroup(){
    ...
    const {data,error,loaded,setLoaded} = useDataFetch("/api/admin/age-group");
    ...
    const handleSubmit = e => {
        ...
        axios.post('/api/admin/age-group',{id,title,description})
        .then(response =>
           { 
            if (response.status==200){
                handleModalClose();
                alert(id?"Age Group Updated": "Age Group Added");
                setId(null);
                setLoaded(false);
            }
           }
    ...
    return (
          ...
          <Head>
            ...
            <div className="row bg-contentbgColor">
                    ...
                    >
                            ...
                            <Card.Body>
                                <div className="row">
                                    <div className="col-md-8">
                                       <span className="h4"> Age Group </span>
                                    </div>
                        ...
                        <Card>
                            <Card.Body>
                                <div className="text-center text-danger"> No Age Groups added
                                </div>
                            </Card.Body>
                        </Card>
                       </>}
        ...
        <Modal show={modalShow} onHide={handleModalClose}>
            ...
            <Modal.Title >
            {id ? <>Update Age Group</> :  <>Create New Age Group</>}        
            </Modal.Title>
            </Modal.Header>
            <Modal.Body>
